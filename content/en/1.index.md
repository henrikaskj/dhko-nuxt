...
To support this development, we will collaborate with similar networks in other countries in Europe, with a particular focus on the Nordic region. Here, [DHNB](https://dhnb.eu/) is an organization we see as important for covering the Nordic and Baltic regions. DHKO is also an associated partner of [MishMash Centre for AI and Creativity](https://mishmash.no/), a Norwegian AI centre that brings together more than 200 researchers and a wide range of public and private sector partners. MishMash explores AI in relation to creative practice, including co-creative systems, education, and the ethical and societal implications of AI. The partnership gives DHKO members access to MishMash work packages and weekly webinars (MeshUps).
