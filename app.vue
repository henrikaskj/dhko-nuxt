<template>
  <div class="min-h-screen flex flex-col" :key="i18n.locale">
    ...
    <header class="p-10 bg-gradient-to-tr bg-slate-700 shadow-md flex flex-col justify-center items-center">
      ...
      <h2 class="text-xl lg:text-2xl text-slate-50 text-center">{{$t('description')}}</h2>
